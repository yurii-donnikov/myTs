...
class Render {
    ...
    createCardForm(event) {
        ...
        if (!this.modal.querySelector(".accountInfo")) {
            ...
            (_a = this.modal.querySelector("form")) === null || _a === void 0 ? void 0 : _a.append(form);
        }
    }
    ...
    showeModal(dataClient) {
        var _a;
        const id = (_a = dataClient === null || dataClient === void 0 ? void 0 : dataClient.id) !== null && _a !== void 0 ? _a : 0;
